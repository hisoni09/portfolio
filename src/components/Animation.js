        ...
        <Container>
            <AnimationSVG>
                ...
                <div class="svg-box">
                    ...
                    <g id="Ship">
                        <g id="mid-display">
                            <rect width="320.3" height="207" x="248.8" y="116.3" fill="#282e39" stroke="rgb(183, 202, 1)" stroke-miterlimit="10" stroke-width="5" opacity=".8" rx="18.4" />
                            <g id="graph-btm">
                                <path id="graph-left" fill="rgb(183, 202, 1)" d="M439.7 292.1s4.5-19.4 8.7-19c3.6.3 4.6 9.2 7.3 9 3.4-.2 4-14 7.3-14.3 3-.2 4.7 10 8.3 10 4 0 5.1-12.6 8.8-12.8 4.1-.2 7.2 27.1 7.2 27.1z" />
                            ...
                            <g id="planet">
                                ...
                                <ellipse id="planet-circle" cx="331.5" cy="207.8" fill="none" stroke="rgb(183, 202, 1)" stroke-miterlimit="10" stroke-width="5" rx="61.8" ry="12.7" />
                            ...
                            <g class="graph-circle-lb" id="graph-cir-mid">
                                ...
                                <path fill="rgb(183, 202, 1)" d="M345.4 287.5l5.2-20.1a20.8 20.8 0 0115.5 20z" />
                            </g>
                            <g id="graph-cir">
                                ...
                                <circle id="graph-cir-1" cx="408" cy="292.1" r="2.3" fill="rgb(183, 202, 1)" />
                                <circle id="graph-cir-2" cx="396.4" cy="275.7" r="2.3" fill="rgb(183, 202, 1)" />
                                <circle id="graph-cir-3" cx="417.2" cy="292.1" r="2.3" fill="rgb(183, 202, 1)" />
                                <circle id="graph-cir-mid-2" cx="396.4" cy="292.1" r="2.3" fill="rgb(183, 202, 1)" data-name="graph-cir-mid" />
                            </g>
                            <g id="graph-big" clip-path="url(#clip-path)">
                                <path id="graph-line" fill="none" stroke="rgb(183, 202, 1)" stroke-miterlimit="10" stroke-width="5" d="M439.7 206.4c26.3 0 26.3 34.2 52.6 34.2s26.3-34.2 52.6-34.2 26.3 34.2 52.6 34.2 26.3-34.2 52.6-34.2" />
                            </g>
                            <circle cx="275.7" cy="139.7" r="11.8" fill="#34496a" />
                            <circle id="left-top-circle" cx="275.7" cy="139.7" r="11.8" fill="rgb(183, 202, 1)" />
                            ...
                            <path class="circles-top" id="circle-l" fill="none" stroke="rgb(183, 202, 1)" stroke-miterlimit="10" stroke-width="5" d="M448 148.2a13.3 13.3 0 11-13.2 13.3 13.3 13.3 0 0113.3-13.3" />
                            ...
                            <path class="circles-top" id="circle-r" fill="none" stroke="rgb(183, 202, 1)" stroke-miterlimit="10" stroke-width="5" d="M534.4 148.2a13.3 13.3 0 11-13.3 13.3 13.3 13.3 0 0113.3-13.3" />
                        </g>
                        <g id="btm-display">
                            <g id="right-display">
                                <g id="right-display-display">
                                    <path fill="#282e39" stroke="rgb(183, 202, 1)" stroke-miterlimit="10" stroke-width="5" d="M654.7 461H508.6c-10.5 0-15.8-8.5-12-19l26.2-72a29.9 29.9 0 0125.8-18.9h146c10.5 0 15.8 8.5 12 19l-26.2 72a29.9 29.9 0 01-25.7 18.8z" opacity=".8" />
                                    <g id="bars">
                                        <polygon id="bar-3-btm" fill="#34496a" points="656.9 441.2 642.4 441.2 667.6 371.7 682.2 371.7 656.9 441.2" />
                                        <polygon id="bar-3-top" fill="rgb(183, 202, 1)" points="656.9 441.2 642.4 441.2 653 412 667.5 412 656.9 441.2" />
                                        <polygon id="bar-2-btm" fill="#34496a" points="633.7 441.2 619.2 441.2 644.5 371.7 659 371.7 633.7 441.2" />
                                        <polygon id="bar-2-top" fill="rgb(183, 202, 1)" points="633.7 441.2 619.2 441.2 636 395.1 650.5 395.1 633.7 441.2" />
                                    ...
                                    <g id="btns" fill="#0ff">
                                        <ellipse fill="rgb(183, 202, 1)" cx="546.8" cy="379.3" rx="6.5" ry="4.6" transform="rotate(-39.8 546.8 379.3)" />
                                        <ellipse cx="562.7" cy="379.3" rx="6.5" ry="4.6" transform="rotate(-39.8 562.7 379.3)" />
                                        <ellipse fill="rgb(183, 202, 1)"cx="578.6" cy="379.3" rx="6.5" ry="4.6" transform="rotate(-39.8 578.6 379.3)" />
                                        <ellipse fill="rgb(183, 202, 1)" cx="594.5" cy="379.3" rx="6.5" ry="4.6" transform="rotate(-39.8 594.5 379.3)" />
                                        <ellipse fill="rgb(183, 202, 1)" cx="540.6" cy="396.3" rx="6.5" ry="4.6" transform="rotate(-39.8 540.6 396.3)" />
                                        <ellipse cx="556.5" cy="396.3" rx="6.5" ry="4.6" transform="rotate(-39.8 556.5 396.3)" />
                                        <ellipse fill="rgb(183, 202, 1)" cx="572.4" cy="396.3" rx="6.5" ry="4.6" transform="rotate(-39.8 572.4 396.3)" />
                                        ...
                                        <ellipse fill="rgb(183, 202, 1)" cx="550.3" cy="413.3" rx="6.5" ry="4.6" transform="rotate(-39.8 550.3 413.3)" />
                                        <ellipse fill="rgb(183, 202, 1)" cx="566.2" cy="413.3" rx="6.5" ry="4.6" transform="rotate(-39.8 566.2 413.3)" />
                                        ...
                                        <ellipse fill="rgb(183, 202, 1)" cx="544.1" cy="430.3" rx="6.5" ry="4.6" transform="rotate(-39.8 544.1 430.3)" />
                                        <ellipse cx="560" cy="430.3" rx="6.5" ry="4.6" transform="rotate(-39.6 562.3 429.7)" />
                                        <ellipse fill="rgb(183, 202, 1)" cx="575.9" cy="430.3" rx="6.5" ry="4.6" transform="rotate(-39.8 576 430.3)" />
                                    </g>
                                </g>
                            ...
                            <g id="left-display">
                                <g id="left-display-display">
                                    <path fill="#282e39" stroke="rgb(183, 202, 1)" stroke-miterlimit="10" stroke-width="5" d="M299 461H153c-10.4 0-22-8.5-25.8-19L101 370c-3.8-10.4 1.6-18.9 12-18.9h146c10.5 0 22 8.5 25.9 18.9l26.2 72c3.8 10.4-1.6 19-12 19z" opacity=".8" />
                                    ...
                                    <polygon fill="rgb(183, 202, 1)" points="198.2 380.9 197 377.7 195.9 374.6 199.2 376.1 202.6 377.7 200.4 379.3 198.2 380.9" />
                                    <line x1="217.3" x2="267.5" y1="377.7" y2="377.7" fill="#282e39" stroke="rgb(183, 202, 1)" stroke-linecap="round" stroke-miterlimit="10" stroke-width="5" opacity=".8" />
                                    <ellipse cx="206.2" cy="397.6" fill="#34496a" rx="5.4" ry="7.7" transform="rotate(-50.2 206.2 397.6)" />
                                    <polygon fill="rgb(183, 202, 1)" points="205.4 400.7 204.2 397.6 203.1 394.4 206.4 396 209.8 397.6 207.6 399.2 205.4 400.7" />
                                    <line x1="224.5" x2="274.8" y1="397.6" y2="397.6" fill="#282e39" stroke="rgb(183, 202, 1)" stroke-linecap="round" stroke-miterlimit="10" stroke-width="5" opacity=".8" />
                                    <ellipse cx="213.5" cy="417.5" fill="#34496a" rx="5.4" ry="7.7" transform="rotate(-50.2 213.4 417.4)" />
                                    <polygon fill="rgb(183, 202, 1)" points="212.6 420.6 211.5 417.5 210.3 414.3 213.7 415.9 217 417.5 214.8 419 212.6 420.6" />
                                    <line x1="231.8" x2="282" y1="417.5" y2="417.5" fill="#282e39" stroke="rgb(183, 202, 1)" stroke-linecap="round" stroke-miterlimit="10" stroke-width="5" opacity=".8" />
                                    <ellipse cx="220.7" cy="437.3" fill="#34496a" rx="5.4" ry="7.7" transform="rotate(-50.2 220.7 437.3)" />
                                    <polygon fill="rgb(183, 202, 1)" points="219.8 440.5 218.7 437.3 217.6 434.2 220.9 435.8 224.3 437.3 222.1 438.9 219.8 440.5" />
                        ...
                        <g id="robot">
                            <path fill="#1A1B1B" d="M490.4 368.3c0 63.7-38 140-84.7 140s-84.8-76.3-84.8-140 38-90.6 84.8-90.6 84.7 26.9 84.7 90.6z" stroke="rgb(183, 202, 1)" stroke-miterlimit="10" stroke-width="2" />
                            <g>
                                <ellipse cx="405.6" cy="543.9" fill="#1e3855" rx="44.5" ry="7.1" />
                                <g>
                                    <g id="faces face-adjustment">
                                        <g>
                                            <ellipse id="face-back" cx="425" cy="340.9" fill="#34496a" rx="51.5" ry="32.2" stroke="rgb(183, 202, 1)" stroke-miterlimit="10" stroke-width="2" />
                                            <g class="eyes" id="eyes" fill="#0ff">
                                                <ellipse cx="445.0" cy="340.9" rx="7.3" ry="13.7" />
                                                <ellipse cx="410.1" cy="340.9" rx="7.3" ry="13.7" />
                                            </g>
                                        </g>
                                    </g>
                                </g>
                            </g>
                            <path id="right-hand" fill="#1A1B1B" d="M549.7 400.7c0 15.6-31.2 28.2-56.2 28.2s-34.2-12.6-34.2-28.2 9.2-28 34.2-28 56.2 12.5 56.2 28z" stroke="rgb(183, 202, 1)" stroke-miterlimit="10" stroke-width="2" />
                            <path id="left-hand" fill="#1A1B1B" d="M255.6 400.7c0-15.5 31.2-28 56.2-28s34.2 12.5 34.2 28-9.3 28.2-34.2 28.2-56.2-12.6-56.2-28.2z" stroke="rgb(183, 202, 1)" stroke-miterlimit="10" stroke-width="2" />
                        </g>
